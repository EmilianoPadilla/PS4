...
class Message(object):
    ...
    def apply_shift(self, shift):
            ...
            for ch in self.message_text:
                if ch in shift_dict:
                    new_ch = shift_dict[ch]
                    shifted_message += new_ch
                else: 
                    shifted_message += ch
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        for shift in range(26):
            ...
            message_by_words = shifted_message.split()
...
# print(msg.decrypt_message()) #prints the tuple on the same line
    ...
    shift, decrypted = msg.decrypt_message() #Prints the tuple on different lines
